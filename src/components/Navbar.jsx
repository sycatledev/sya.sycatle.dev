export default function Navbar({ toggleTheme, isBlackTheme, logout }) {
    return <header className="fixed top-0 left-0 font-semibold p-2 text-black backdrop-blur-lg bg-zinc-50/70 dark:bg-zinc-900/70 dark:text-white w-full duration-300 z-50">
