...
export default function Menu({ username, setMessages }) {
    ...
    return <nav className="fixed bottom-0 left-0 font-semibold py-2 lg:py-4 text-black backdrop-blur-lg bg-zinc-50/70 dark:bg-zinc-900/70 dark:text-white w-full duration-300">
    <Flickity
