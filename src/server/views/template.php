...
<body class="bg-zinc-50 text-black dark:bg-zinc-900 dark:text-white duration-300">
    <main class="mx-auto mt-auto max-w-7xl py-16 space-y-8 text-xl min-h-screen"> 
        <header id="header" class="fixed top-0 left-0 font-semibold p-2 lg:p-4 text-black backdrop-blur-lg bg-zinc-50/70 dark:bg-zinc-900/70 dark:text-white w-full duration-300 z-50">
            <div class="flex max-w-7xl mx-auto p-2 items-center">
                <a href="." class="inline-flex items-center space-x-2 z-40">
        ...
        <footer>    
            <span class="hidden lg:inline-flex fixed right-0 bottom-0 p-2 mt-auto text-sm items-center text-gray-400 font-thin">
                Sya v1.0-ALPHA
